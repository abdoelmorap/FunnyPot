package store.funnypot.util.helper;

public abstract class Constants {
    public  static final String URL="https://api.funnypot.store";
    public static final String HTTP_HEADER_ACCEPT = "Accept";
    public static final String HTTP_HEADER_ACCEPT_GITHUB_V3 = "application/vnd.github.v3+json";
